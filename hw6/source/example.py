...
def localization_solve(distances_to_station, stations_coordinates):
	def error(x, c, r):
		return *you should complete this function by calculating the error*
...
if __name__ == "__main__":
	...
	print(localization_solve(distances_to_station, stations))
